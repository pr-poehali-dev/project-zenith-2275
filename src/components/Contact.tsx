      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div>
            ...
            >
              Расскажите о вашем грузе и направлении — мы подберём оптимальный маршрут и рассчитаем
              стоимость. Ответим в течение рабочего дня.
            </p>
            ...
            >
              <div>
                ...
                <a href="mailto:hello@lumen-logistics.com" className="text-foreground hover:text-sage transition-colors">
                  hello@lumen-logistics.com
                </a>
              </div>
              <div>
