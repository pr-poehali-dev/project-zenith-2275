  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6 lg:px-12 pt-20">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        >
          Интеллектуальная международная логистика
        </p>
        ...
        >
          Платформа международной логистики на основе искусственного интеллекта. Прокладываем оптимальные маршруты, прогнозируем сроки и берём на себя весь путь груза — от отправки до получения.
        </p>
