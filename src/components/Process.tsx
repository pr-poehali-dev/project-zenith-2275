...
const steps = [
  {
    ...
    title: "Заявка",
    description:
      "Вы указываете параметры груза, точки отправки и доставки. Платформа за секунды рассчитывает стоимость и сроки по нескольким маршрутам.",
  },
  {
    number: "02",
    title: "Расчёт маршрута",
    description:
      "Искусственный интеллект анализирует загрузку портов, погоду и таможенные сроки и предлагает оптимальный путь для вашего груза.",
  },
  {
    number: "03",
    title: "Отправка и контроль",
    description:
      "Мы организуем перевозку и оформляем все документы. Вы отслеживаете движение груза в реальном времени из личного кабинета.",
  },
  {
    number: "04",
    title: "Доставка",
    description:
      "Груз прибывает точно в срок. Аналитика по маршруту помогает оптимизировать ваши следующие поставки.",
  },
]
        ...
        <div className="grid lg:grid-cols-12 gap-16 lg:gap-24">
          ...
          <div className="lg:col-span-4">
            <div className="lg:sticky lg:top-32">
              ...
              >
                Путь
                <span className="italic"> вашего груза</span>
              </h2>
              <p
              ...
              >
                Прозрачный процесс на каждом этапе. От заявки до доставки технология и команда экспертов
                работают вместе, чтобы ваш груз пришёл вовремя и без сюрпризов.
              </p>
            </div>
          </div>
